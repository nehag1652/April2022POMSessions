...
public class RegisterPage {
	...
	// private By subscribeYes =
	// By.xpath("(//label[@class='radio-inline'])[position()=1]/input");
	// private By subscribeNo =
	// By.xpath("(//label[@class='radio-inline'])[position()=2]/input");
...
//			}
		...
		String actSuccessMesg = eleUtil.waitForVisibleElement(this.sucessMessg, AppConstants.MEDIUM_DEFAULT_TIME_OUT)
				.getText();
