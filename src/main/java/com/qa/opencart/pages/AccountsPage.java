...
public class AccountsPage {
	...
	public boolean isLogoutLinkExist() {
		return eleUtil.waitForVisibleElement(logoutLink, AppConstants.MEDIUM_DEFAULT_TIME_OUT).isDisplayed();
	}

	public boolean isSearchFieldExist() {
		return eleUtil.waitForVisibleElement(searchField, AppConstants.SMALL_DEFAULT_TIME_OUT).isDisplayed();
	}
